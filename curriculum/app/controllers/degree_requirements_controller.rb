class DegreeRequirementsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @degree_requirement.save
        ...
        format.json { render action: 'show', status: :created, location: @degree_requirement }
      else
  ...
  private
    ...
    def degree_requirement_params
      params.require(:degree_requirement).permit(:degree_plan_id, :name, :category, :min_grade, :crucial, :note)
    end
end
