class PrerequisitesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @prerequisite.save
        ...
        format.json { render action: 'show', status: :created, location: @prerequisite }
      else
  ...
  private
    ...
    def prerequisite_params
      params.require(:prerequisite).permit(:course_id, :prereq_id, :corequisite, :strict_corequisite, :description, :position, :or_connector)
    end
end
